...
// Execute: cd aps-mcp-server && node ../test-tool.js <accountId>
...
// Carregar variáveis de ambiente do aps-mcp-server
dotenv.config({ path: join(__dirname, 'aps-mcp-server', '.env') });

// Importar a tool compilada
const { getAllBimModels } = await import('./aps-mcp-server/build/tools/get-all-bim-models.js');
