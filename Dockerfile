...
WORKDIR /app/aps-mcp-server
RUN echo "APS_CLIENT_ID=6UyGgnLeTVdbZ9GHUUq7M5tADlmwV5usjmbPWUhcoPomE2Fm" > /app/aps-mcp-server/.env && \
    ...
    echo "APS_SA_EMAIL=ssa-ihan-barbosa@6UyGgnLeTVdbZ9GHUUq7M5tADlmwV5usjmbPWUhcoPomE2Fm.adskserviceaccount.com" >> /app/aps-mcp-server/.env && \
